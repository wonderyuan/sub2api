...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	monitorCenterCache := repository.NewMonitorCenterCache(redisClient)
	monitorCenterService := service.ProvideMonitorCenterService(opsRepository, channelMonitorService, monitorCenterCache)
	...
	opsService := service.ProvideOpsService(opsRepository, settingRepository, configConfig, monitorCenterService, accountRepository, userRepository, concurrencyService, gatewayService, openAIGatewayService, geminiMessagesCompatService, antigravityGatewayService, opsSystemLogSink, settingService, authCacheInvalidationWorker, apiKeyService)
	codexRadarService, err := service.NewCodexRadarService()
	if err != nil {
		return nil, err
	}
	usageHandler := handler.ProvideUsageHandler(usageService, apiKeyService, opsService, settingService, codexRadarService)
	...
	alwaysStepUpAuthMiddleware := middleware.NewAlwaysStepUpAuthMiddleware(totpService, userService)
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, alwaysStepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, compositeRouteResolver, redisClient)
	...
	v := provideCleanup(client, redisClient, concurrencyService, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, cnProviderBalanceCheckService, openAICodexVersionSyncService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, channelMonitorV2Aggregator, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, auditLogService, openAIQuotaAutoResetService, promptService, pluginManager)
