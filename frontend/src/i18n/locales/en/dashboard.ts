export default {
  dashboard: {
    ...
    recentRange: 'Recent time range',
    recentMinutes: 'Last {count}m',
    recentHalfHour: 'Last 30m',
    recentHours: 'Last {count}h',
    ...
    modelRecommendations: {
      ...
      levels: 'levels',
      displayMode: 'Intelligence recommendation display',
  ...
  keys: {
    ...
    regenerateKeyConfirmTitle: 'Regenerate API Key',
    regenerateKeyConfirmMessage: "Regenerate the secret for '{name}'? The current secret will be invalidated immediately. Balance, usage, rate limits, and all settings will be retained.",
    keyRegeneratedSuccess: 'API key regenerated. Copy the new secret now.',
    failedToRegenerateKey: 'Failed to regenerate API key',
    id: 'ID',
    apiKey: 'API Key',
    group: 'Group',
    ...
    sync7dWindowAccount: 'Sync Upstream Account 7-Day Window',
    sync7dWindowAccountNone: 'Do not sync',
    sync7dWindowAccountHint: 'Choose an account to align this API key 7-day reset time with the account’s currently known 7-day reset time when saving. Existing usage is not cleared automatically.',
    sync7dWindowAccountSelected: 'Will sync to: {time}',
    sync7dWindowAccountEmpty: 'No syncable account window yet. Query or sample the target account’s 7-day usage window on the account page first.',
