export default {
    ...
    dashboard: {
      ...
      rateLimits: {
        ...
        fiveHourGrok: 'Request limit',
        sevenDay: '7-day limit',
        sevenDayGrok: 'Weekly limit',
        sevenDayUsdCapacity: 'Current 7-day USD remaining',
        estimatedTotal: 'Est. window total {amount}',
        planTotal: 'Plan weekly total {amount}',
        actualRemaining: 'Actual remaining',
        officialRemaining: 'Est. upstream remaining',
        unallocatedRemaining: 'Unallocated remaining',
        remainingAmount: '{amount} left',
        usedAmount: '{amount} used',
        localUsedAmount: '{amount} used in local billing',
        allocatedAmount: '{amount} allocated',
        allocatedUnlimited: 'Unlimited key allocated',
        allocationUnavailable: 'Allocation is temporarily unavailable',
        capacityUnavailable: 'Not enough data to estimate this window\'s USD capacity',
        ...
        resetCreditsCount: '{count} cards',
        resetCreditsUnknown: 'Not queried',
        resetCreditsRefresh: 'Refresh reset credits',
        resetCreditsRefreshHint: 'Query reset-credit counts and expirations for OpenAI OAuth parent accounts on this page',
        resetCreditsRefreshSuccess: 'Updated reset credits for {count} OpenAI accounts',
        resetCreditsRefreshPartial: 'Reset-credit query finished: {success} succeeded, {failed} failed',
        resetCreditsRefreshFailed: 'Failed to query reset credits',
        resetCreditsUnavailable: 'Reset credits have not been queried. Refresh this page to check.',
        resetCreditsNoAvailable: 'No reset credits available',
        resetCreditsExpiryUnavailable: 'The upstream did not return individual card expiration times',
        resetCreditsExpiryPartial: 'The upstream returned expiration times for {shown}/{total} reset cards',
        resetCreditsExpiresAt: 'Expires {time}',
        resetCreditsCheckedAt: 'Checked {time}',
        resetCreditsDetails: 'Show reset-credit expiration times',
        keyExpiryDaysLeft: '{days} days left',
        keyExpiryExpired: 'Expired',
        keyExpiryNever: 'Never expires',
        keyExpiryTitle: 'Latest API key expiry: {time}',
