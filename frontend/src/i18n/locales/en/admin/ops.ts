export default {
    ops: {
      ...
      failedToLoadLatencyTrend: 'Failed to load service response time trend',
      ...
      failedToLoadUserErrorDistribution: 'Failed to load error distribution by user',
      failedToLoadInvestigation: 'Failed to load investigation findings',
      failedToLoadPerformanceDiagnostics: 'Failed to load performance diagnostics',
      failedToLoadErrorDetail: 'Failed to load error detail',
      retryFailed: 'Retry failed',
      tpsK: 'TPS (K)',
      top: 'Top:',
      throughputTrend: 'Throughput Trend',
      responseTimeTrend: 'Service Response Time',
      ...
      userLatency: {
        ...
        topAvg: 'Highest average duration',
        deleted: 'Deleted',
        summary: '{count} successful requests, {avg} average',
        emptyUser: 'This user has no successful request-duration samples in the current window.',
        bucketDetails: 'Request duration {range}'
      },
      userErrors: {
        title: 'Request Errors by User',
        summary: '{users} users, {errors} SLA errors',
        unknownUser: 'Unknown user',
        unknownType: 'Unknown error',
        userTotal: 'User total: {count}',
        topLimit: 'Showing the top {count} users by error count.'
      },
      ...
      performance: {
        ...
        primaryCause: 'Primary cause: {cause}, representing {share} of slow requests',
        noSlowRequests: 'No requests crossed a phase threshold or failed in the selected window',
        slowRate: 'Slow rate',
        endToEndTtftP95: 'End-to-end TTFT P95',
        ingestionLoss: 'Since this service instance started, {dropped} diagnostics events were dropped and {failed} failed to write. Slow-cause data for the selected range may be incomplete.',
        ingestionBacklog: 'The diagnostics write queue is near capacity ({depth}/{capacity}); slow-cause data may appear late.',
        causeRanking: 'Cause ranking',
        causeTrend: 'Slow cause trend',
        slowRequestsAxis: 'Slow requests',
        impactScope: 'Impact scope',
        queueP95: 'Queue P95',
        requests: 'Requests',
        mainCause: 'Main cause',
        detailedAnalysis: 'Detailed analysis and error drilldowns',
        dimensions: { user: 'User', account: 'Account', model: 'Model' },
        causes: {
          healthy: 'Healthy',
          user_queue: 'User concurrency queue',
          heavy_queue: 'Heavy lane queue',
          recovery_queue: 'Recovery lane queue',
          request_body_lane_queue: 'Request lane queue',
          account_queue: 'Account concurrency queue',
          body_read: 'Body upload and read',
          routing: 'Internal routing',
          upstream_ttft: 'Slow upstream first token',
          stream_gap: 'Mid-stream output stall',
          failover: 'Account failover and retry',
          upstream: 'Slow upstream processing',
          internal: 'Internal processing',
          request_too_large: 'Request body too large',
          queue_rejected: 'Concurrency queue rejected',
          recovery_deadline: 'Recovery deadline exceeded',
          client_canceled: 'Client canceled request',
          no_available_account: 'No available account',
          upstream_error: 'Upstream request failed',
          request_rejected: 'Request rejected by gateway'
        }
      },
      concurrencyTrend: {
        title: 'User concurrency peaks · Selected range',
        subtitle: 'Concurrency peaks and request latency split by normal, heavy, and recovery lanes',
        ...
        demandStatistics: 'Concurrency demand (requests)',
        responseTimeStatistics: 'Response time (ms)',
        ...
        laneEmpty: 'No concurrency activity in this lane during the selected range',
        empty: 'No concurrency activity in the selected range',
        partialCoverage: 'Concurrency snapshots are retained for 24 hours. Showing available data from {start} to {end}.',
        unavailableCoverage: 'The selected range is outside the 24-hour concurrency snapshot retention window.',
      ...
      tooltips: {
        ...
        userLatency: "Full successful-request duration by user. Buckets adapt to the selected user's actual p95, with extreme tail requests isolated.",
        ...
        userErrors: "SLA errors grouped by user and error type, excluding business limits and sorted by each user's total error count.",
        goroutines:
