export default {
    ...
    dashboard: {
      ...
      rateLimits: {
        ...
        sevenDay: '7 天限额',
        sevenDayGrok: '周限额',
        sevenDayUsdCapacity: '当前 7 天窗口美元余量',
        estimatedTotal: '本轮估算总额 {amount}',
        planTotal: '套餐周总额 {amount}',
        actualRemaining: '实际使用余量',
        officialRemaining: '官方余量估算',
        unallocatedRemaining: '分配余量',
        remainingAmount: '剩余 {amount}',
        usedAmount: '已用 {amount}',
        localUsedAmount: '本地计费已用 {amount}',
        allocatedAmount: '已分配 {amount}',
        allocatedUnlimited: '已分配不限额 Key',
        allocationUnavailable: '分配额度暂无法查询',
        capacityUnavailable: '本周期暂无足够数据估算美元额度',
        ...
        liveFailed: '实时查询上游失败',
        resetCredits: '重置卡',
        resetCreditsCount: '{count} 张',
        resetCreditsUnknown: '未查询',
        resetCreditsRefresh: '刷新重置卡',
        resetCreditsRefreshHint: '查询当前页 OpenAI OAuth 母账号的重置卡数量和到期时间',
        resetCreditsRefreshSuccess: '已更新 {count} 个 OpenAI 账号的重置卡',
        resetCreditsRefreshPartial: '重置卡查询完成：成功 {success} 个，失败 {failed} 个',
        resetCreditsRefreshFailed: '重置卡查询失败',
        resetCreditsUnavailable: '暂未查询重置卡；可点击上方按钮刷新当前页',
        resetCreditsNoAvailable: '暂无可用重置卡',
        resetCreditsExpiryUnavailable: '上游未返回各张重置卡的到期时间',
        resetCreditsExpiryPartial: '上游仅返回 {shown}/{total} 张重置卡的到期时间',
        resetCreditsExpiresAt: '{time} 到期',
        resetCreditsCheckedAt: '{time} 查询',
        resetCreditsDetails: '展开重置卡到期时间',
        keyExpiryDaysLeft: '剩余 {days} 天',
        keyExpiryExpired: '已过期',
        keyExpiryNever: '永久有效',
        keyExpiryTitle: '最晚 API Key 到期时间：{time}',
        loadFailed: '加载速率限额失败',
        retry: '重试',
        empty: '没有符合条件的记录',
        unavailable: '暂无上游数据',
