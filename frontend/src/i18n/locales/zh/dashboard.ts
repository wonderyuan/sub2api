export default {
  ...
  keys: {
    ...
    regenerateKeyConfirmTitle: '重新生成 API 密钥',
    ...
    sync7dWindowAccount: '同步上游账号 7 天窗口',
    sync7dWindowAccountNone: '不同步',
    sync7dWindowAccountHint: '选择账号后，保存时会把此 API Key 的 7 天刷新时间对齐到该账号当前已知的 7 天刷新时间；不会自动清零已用额度。',
    sync7dWindowAccountSelected: '将同步到：{time}',
    sync7dWindowAccountEmpty: '暂无可同步的账号窗口。请先在账号管理页查询或采样目标账号的 7 天用量窗口。',
    ...
    sync7dWindowSourceZhipu: '智谱周窗口',
    sync7dWindowSourceKimi: 'Kimi周窗口',
  ...
  usage: {
    ...
    recentRange: '最近时间范围',
    recentMinutes: '近 {count} 分钟',
    recentHalfHour: '近半小时',
    recentHours: '近 {count} 小时',
    costDetails: '费用明细',
